      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-800 p-6 sm:p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold mb-6 text-orange-500">Get in Touch</h2>
            
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-orange-500 p-3 rounded-full text-gray-900">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold">Owotoki Ayomide</p>
                </div>
              </div>
          ...
          <div className="flex flex-col justify-center items-center space-y-6">
            <div className="bg-gray-800 p-8 rounded-lg shadow-lg text-center w-full">
              ...
              <h2 className="text-2xl font-bold mb-4">Contact via WhatsApp</h2>
              <p className="text-gray-400 mb-6">
                Got questions or want to discuss a project? Reach out to me directly on WhatsApp for quick responses!
              </p>
              
              <a
                href="https://wa.me/+2348133686472"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-full transition duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl w-full sm:w-auto"
              >
              ...
              <p className="text-gray-500 text-sm mt-6">
                Available any for freelance projects and collaborations
              </p>
            </div>
          </div>
        </div>
